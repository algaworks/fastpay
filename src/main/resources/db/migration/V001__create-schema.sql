...
create table public.payment (
    ...
    state varchar(255),
    status varchar(255),
    tokenized_credit_card_id varchar(255),
...
create index idx_payment_tokenized_credit_card_id on public.payment (tokenized_credit_card_id);
create index idx_payment_reference_code on public.payment (reference_code);

alter table public.payment add constraint fk_payment_tokenized_credit_card_id foreign key (tokenized_credit_card_id) references public.credit_card(id);